...
// Manually parse .env because I can't rely on global dotenv install in root
  ...
  try {
    ...
    for (const statement of statements) {
      try {
        ...
        console.warn(`Statement failed (maybe columns exist?): ${e.message}`);
      }
    }
    
    // Also record it in migrations table if exists
    try {
