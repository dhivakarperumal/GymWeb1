            ...
            <section className="min-h-screen bg-black text-white py-16">
                <PageContainer className="space-y-10">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-red-500 uppercase tracking-[0.35em] text-sm font-semibold mb-2">
                            DAP Fitness Studio
                        </p>
                        ...
                        <p className="text-white/70 leading-relaxed text-lg">
                            At DAP Fitness Studio, we respect your privacy and are committed to protecting the personal information you entrust to us.
                        </p>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto space-y-10 text-white/75 text-[15px] leading-8">
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                All membership fees, advance payments, and package amounts paid to DAP Fitness Studio are non-refundable under any circumstances.
                            </p>

                            <p>
                                Members are requested to review all plans, pricing, and services carefully before making payment.
                            </p>
                        </section>
