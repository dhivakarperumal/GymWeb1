        ...
        <div className={isModal ? "w-full" : "max-w-5xl mx-auto py-10"}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-h-[80vh] overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div className="space-y-4">
                <h1 className="text-white text-4xl font-bold border-b border-white/10 pb-1 uppercase tracking-widest italic">Enquiry Form</h1>
                <h3 className="text-[#FF3131] font-bold border-b border-white/10 pb-1 uppercase tracking-widest text-sm">Personal Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setLocalFormData({...localFormData, age: e.target.value})}
                        className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, blood_group: e.target.value})}
              ...
              <div className="space-y-4">
                <h3 className="text-[#FF3131] font-bold border-b border-white/10 pb-1 uppercase tracking-widest text-sm">Professional Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, employer: e.target.value})}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, occupation: e.target.value})}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-[#FF3131] font-bold border-b border-white/10 pb-1 uppercase tracking-widest text-sm">In Case of Emergency</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, emergency_contact_name: e.target.value})}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, emergency_contact_relationship: e.target.value})}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, emergency_contact_phone_home: e.target.value})}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalFormData({...localFormData, emergency_contact_phone_work: e.target.value})}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setLocalFormData({...localFormData, emergency_contact_address: e.target.value})}
                    rows={2}
                    className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-[#FF3131] font-bold border-b border-white/10 pb-1 uppercase tracking-widest text-sm">Health & Fitness Goals</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full px-3 py-2 bg-white/20 border border-white/20 rounded-lg text-[#FF3131] font-bold focus:outline-none"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setLocalFormData({...localFormData, fitness_goal: e.target.value})}
                    rows={2}
                    className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div className="flex gap-3 pt-6">
                <button
                  ...
                  className={`flex-1 px-6 py-4 rounded-md font-bold text-xs uppercase tracking-widest transition-all ${
                    isFirstStep
                ...
                <button
                  ...
                  className="flex-1 px-6 py-4 bg-white/5 hover:bg-white/10 text-white rounded-md font-bold text-xs uppercase tracking-widest transition-all border border-white/10"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-4 bg-[#FF3131] hover:bg-red-700 text-white rounded-md font-bold text-xs uppercase tracking-widest shadow-lg hover:shadow-[#FF3131]/20 transition-all"
                >
