...
const FollowupEnquiry = () => {
  ...
  const handleSubmitEnquiry = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 409) {
        toast.error(err.response.data?.error || `This record already exists!`);
      } else {
  ...
  const exportToExcel = () => {
    const dataToExport = filteredEnquiries.map((e, index) => ({
      ...
      "Message/Notes": e.message || "N/A",
      "Gender": e.gender || "N/A",
      "Date of Birth": e.dob ? dayjs(e.dob).format('YYYY-MM-DD') : "N/A",
      "Age": e.age || "N/A",
      "Height": e.height || "N/A",
      "Weight": e.weight || "N/A",
      "BMI": e.bmi || "N/A",
      "Blood Group": e.blood_group || "N/A",
      "Fitness Goal": e.fitness_goal || "N/A",
      "Address": e.address || "N/A",
      "Employer/Organization": e.organization || e.employer || "Direct",
      "Occupation": e.occupation || "N/A",
      "Website": e.website || "N/A",
      "Best Time To Reach": e.best_time_to_reach || "N/A",
      "Emergency Contact Name": e.emergency_contact_name || "N/A",
      "Emergency Contact Rel": e.emergency_contact_relationship || "N/A",
      "Emergency Contact Home": e.emergency_contact_phone_home || "N/A",
      "Emergency Contact Work": e.emergency_contact_phone_work || "N/A",
      "Reg No": e.reg_no || "N/A",
      "Plan Name": e.plan_name || "N/A",
      "Plan Duration": e.plan_duration || "N/A",
      "Plan Price": e.plan_price || "N/A",
      "Status": e.status,
      ...
      "Next Followup Date": e.next_followup_date ? dayjs(e.next_followup_date).format('YYYY-MM-DD') : "N/A",
      "Referred By": e.referred_by || "N/A",
