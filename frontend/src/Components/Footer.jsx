  ...
  return (
    <footer className="bg-black text-white border-t border-red-500/30">
        ...
        >
          ...
          <div>
            ...
            <p className="text-white/70 text-[15px] leading-relaxed text-justify">
              DAP Fitness Studio is a premium fitness center equipped with modern machines, expert trainers, and a motivating environment to help you achieve your fitness goals faster and safer. We focus on strength, discipline, and long-term transformation.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="w-full h-45 rounded-lg overflow-hidden border border-red-500/20">
              <iframe
                title="DAP Fitness Studio Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.003855043013!2d80.22856569999999!3d12.9074734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d8b62199db9%3A0x5d63852cdbe316b8!2sDAP%20fitness%20studio!5e0!3m2!1sen!2sin!4v1778141911152!5m2!1sen!2sin"
      ...
      <div className="border-t border-red-500/20 py-3 text-center text-[13px] text-white/60">
        ...
        <span className="text-red-500 font-semibold">DAP Fitness Studio</span>. All Rights Reserved.
      </div>
    </footer>
  );
};
