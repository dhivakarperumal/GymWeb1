      ...
      <>
        <div className="bg-black text-white min-h-screen py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-red-500">My Plans</h2>
            <p className="text-gray-400 mt-2">Your purchased membership plan details</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center p-12 bg-gray-900/50 rounded-2xl border border-red-500/10 max-w-2xl mx-auto">
              <h2 className="text-xl text-red-500 font-bold">No Active Plans</h2>
              <p className="text-gray-400 mt-2">
                You do not have any active plans right now. Choose the Buy Plan tab to explore membership options.
              </p>
              <button
                onClick={() => navigate("/account", { state: { tab: "buyplan" } })}
                  ...
                  >
                    <button
                      onClick={() => {
                        ...
                        api.delete(`/memberships/${plan.id}`)
                    ...
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-[10px] uppercase font-black tracking-widest ${
                          isExpired ? "bg-gray-800 text-gray-400" : "bg-red-600 text-white animate-pulse"
                        }`}
                      >
